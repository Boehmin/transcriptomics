...
Jupyter+R: [![Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/Boehmin/transcriptomics/master?filepath=index.ipynb)

RStudio: [![Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/Boehmin/transcriptomics/master?urlpath=rstudio)

RShiny: [![Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/Boehmin/transcriptomics/master?urlpath=shiny/bus-dashboard/)
